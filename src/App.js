...
import ListBooks from "./AllBooks";
import "./App.css";
        ...
        <Route
          ...
          render={() =>
            this.state.showSearchPage ? (
              <Search
                searchBar={this.handleSearchBar}
                booksInState={this.state.books}
                updateBook={(book) => this.handleUpdate(book)}
